...
import {
  ...
  CreateExtensionPaymentLinkFormSchema,
  type CreateExtensionPaymentLinkFormValues
...
export function CreateExtensionPaymentLinkForm() {
  return (
    <Stepper.Provider variant='horizontal'>
      <CreateExtensionPaymentLinkFormInner />
    </Stepper.Provider>
  )
}

function CreateExtensionPaymentLinkFormInner() {
  ...
  return (
    <div className='flex flex-col gap-4 w-full'>
      ...
      <StepperContent
        ...
        form={form}
        isLoading={isLoading}
        memberships={findAllMemberships.data}
